...
void init() {
  ...
  teledart
      ...
      .where((message) =>
          message.text.contains('stfu') ||
          message.text.contains('stupid') ||
          message.text.contains('idiot') ||
          message.text.contains('dumb') ||
          message.text.contains('fuck') ||
          message.text.contains('bitch'))
